...
void main() {
  runApp(DepartmentalEvent());
}

// This widget is the root of your application.
@override
class DepartmentalEvent extends StatefulWidget {
  @override
  _DepartEvent createState() => _DepartEvent();
}

class _DepartEvent extends State<DepartmentalEvent> {
  bool isSearching = false;
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: "College Departmental Events",
      debugShowCheckedModeBanner: false,
      home: Scaffold(
        appBar: AppBar(
            title: !isSearching
                ? Text("College Departmental Events")
                : TextField(
                    style: TextStyle(
                      color: Colors.white,
                    ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(10),
                                      child: Image.network(
                                        'https://mscw.ac.in/resources/img/research.jpg',
                                        width: 160,
                                        height: 170,
                                        fit: BoxFit.cover,
                                      ),
                                  ...
                                  Container(
                                    ...
                                    width: 150,
                                    child: Text(
                                      'National Conference on Advances in Applied Mathematics and Statistics',
